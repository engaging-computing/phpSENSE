<?php /* Smarty version 2.6.22, created on 2010-11-05 15:41:06
...
" style="width: 200px;"></input></td>
	    			...
	    			<tr>
	      				...
	      				<td>
							<select name="country" style="width: 200px;">
								...
								<option value="KP">Korea (North) (People's Republic)</option>
								<option value="KR">Korea (South) (Republic)</option>
								<option value="KW">Kuwait</option>
								<option value="KG">Kyrgyzstan (Kyrgyz Republic)</option>
								...
								<option value="NT">Neutral Zone (Saudia Arabia/Iraq)</option>
								...
								<option value="SU">Soviet Union (former)</option>
					...
					<tr>
						<td style="text-align: right; width: 130px; padding-right: 10px;">&nbsp;</td>
						<td><?php echo $this->_tpl_vars['recapatcha']; ?>
</td>
					</tr>
	    			<tr>
	      				<td>&nbsp;</td>
	  	...
	  	<?php else: ?>
	    	<div>You iSENSE account has been successfully setup.</div>
	  	<?php endif; ?>
	<?php else: ?>
		<?php if ($this->_tpl_vars['registered']): ?>
			<p>Congratulations! You've successfully created an iSENSE account. You may now create new experiments and contribute data to existing experiments.</p>
		<?php else: ?>
