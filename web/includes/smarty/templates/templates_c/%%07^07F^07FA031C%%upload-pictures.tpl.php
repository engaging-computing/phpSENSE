<?php /* Smarty version 2.6.22, created on 2011-12-07 12:40:35
         compiled from upload-pictures.tpl */ ?>
	...
	<div id="main">
		<?php if ($this->_tpl_vars['done']): ?>
			<fieldset id="basic-info">
				...
				<p>You've successfully uploaded pictures. You can <a href="upload-pictures.php?id=<?php echo $_GET['id']; ?>
">upload more</a> or <a href="experiment.php?id=<?php echo $_GET['id']; ?>
